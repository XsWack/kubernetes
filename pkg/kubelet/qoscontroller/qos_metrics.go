...
func acquireMemoryMetrics(pod *api.Pod, qosResourceStatus *QosResourceStatus) error {
...
func acquireDiskIOMetrics(pod *api.Pod, qosResourceStatus *QosResourceStatus) error {
	return nil
}

// acquireNetworkIOMetrics calculates/gathers network IO related resources for each of the pod and fills up the map
func acquireNetworkIOMetrics(pod *api.Pod, qosResourceStatus *QosResourceStatus) error {
