...
func (sc *SlaController) GetPodTargetLatency(pod *api.Pod, qosResourceStatus *QosResourceStatus) (float64, error) {
	...
	podTargetLatency, ok := podDeployment.Spec.Sla.SlaSpec[string(api.SlaSpecRT)]
...
func (sc *SlaController) GetPodTargetLatencyFromAnnotation(pod *api.Pod) (float64, error) {
...
qosResourceStatus *QosResourceStatus) ([]extensions.Deployment, error) {
	...
	ds, err := qosResourceStatus.kubeClient.Extensions().Deployments(rs.Namespace).List(api.ListOptions{})
...
func (sc *SlaController) GetPodDeploymentFromApiServer(pod *api.Pod,
qosResourceStatus *QosResourceStatus) (*extensions.Deployment, error) {
...
func slaUpdateActionList(actionList *[]*Action, secondaryPods []*api.Pod, processMultiPod bool) []*api.Pod {
...
func sortPodListStartTime(pods []*api.Pod) {
